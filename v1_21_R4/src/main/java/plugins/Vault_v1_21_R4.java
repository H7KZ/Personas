...
import com.jankominek.personas.utils.EnchantmentUtils;
...
public class Vault_v1_21_R4 implements ISupportedPlugin {
    ...
    private void delayActivation() {
        ...
        // unregister then re register event so it is executed before personas events

...
public class EventUtils {
    public static class Personas {
        public static List<IPluginEnchantment> getPersonasedEnchantments(ItemStack firstItem, ItemStack secondItem, boolean withDelete) {
            ...
            if (Personas.isAtLeastOneEnchantmentDisabled(firstEnchants)) return List.of();
        ...
        public static List<IPluginEnchantment> getPersonasedEnchantments(ItemStack firstItem, ItemStack secondItem, boolean withDelete, ISupportedPlugin activatedPlugin) {
            if (firstItem == null || secondItem == null) return List.of();
            if (firstItem.getType() == Material.AIR || secondItem.getType() == Material.AIR) return List.of();
        ...
        public static List<IPluginEnchantment> findEnchantmentsToDelete(List<IPluginEnchantment> enchantments) {
            ...
            for (IPluginEnchantment enchantment : enchantments) {
                ...
                if (Config.Personas.getEnchantmentStates().getOrDefault(key, EnchantmentStateType.ENABLE) == EnchantmentStateType.DELETE)
        ...
        private static boolean isAtLeastOneEnchantmentDisabled(List<IPluginEnchantment> enchantments) {
            Map<String, EnchantmentStateType> states = Config.Personas.getEnchantmentStates();
        ...
        private static boolean isMaterialDisabled(ItemStack item) {
            return Config.Personas.getDisabledMaterials().stream().anyMatch(m -> m.equals(item.getType()));
        }
    }
